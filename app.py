...
def home_page():
    ...
    response = rson.loads(requests.get("http://api.ipstack.com/" + user_address + "check?access_key=2fe74d1492a0ae71f6423ec9150b3a08&fields=region_code&output=json").text)["region_code"]
